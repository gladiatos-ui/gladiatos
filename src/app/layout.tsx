...
export const metadata: Metadata = {
	...
	description:
		"Gladiatos UI develops advanced humanoid robots and AI-powered autonomous soccerbots, combining real-time perception, dynamic control, and innovation in robotics.",
	twitter: {
...
export default function RootLayout({
	...
	return (
		<html lang="en" suppressHydrationWarning>
			...
			<body
				className={`${inter.className} ${orbitron.variable} bg-background text-text`}
			>
