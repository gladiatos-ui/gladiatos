...
function Navbar() {
	...
	return (
		<>
			<StyledNav
				className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-4 py-2 transition-all duration-300 ${
					isScrolled ? "glassy" : ""
				}`}
			>
				<Link href="/">
			...
			{/* Mobile Menu */}
			<MobileNav
				className={`fixed inset-0 z-40 md:hidden bg-background transition-opacity duration-500 ease-in-out overflow-y-auto ${
					isMobileMenuOpen
