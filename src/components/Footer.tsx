	...
	return (
		<div className="relative w-full">
			...
			<StyledFooter
				...
				style={{
					clipPath: slanted
						? "polygon(0 9vw, 100% 0, 100% 100%, 0 100%)"
						: "none",
				}}
			>
				<div className="container mx-auto">
					...
					<div className="flex gap-4 justify-center mb-12">
						<SocialButton>
							<Link
								href="https://instagram.com/gladiatos.ui"
								target="_blank"
						...
						<SocialButton>
							<Link
								href="https://linkedin.com/company/gladiatos"
								target="_blank"
								rel="noopener noreferrer"
						...
						<SocialButton>
							<Link
								href="https://github.com/Gladiatos-Programming"
								target="_blank"
								rel="noopener noreferrer"
