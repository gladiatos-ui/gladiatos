						...
						<ul className="space-y-4">
							...
							>
								...
								<span className="text-md lg:text-lg text-text">
									...
									and autonomous soccerbots, combining AI, real-time perception,
									and dynamic control to push technological boundaries.
								</span>
							</motion.li>
							...
							>
								...
								<span className="text-md lg:text-lg text-text">
									Our team competes in leading robotics tournaments like{" "}
									<strong className="text-foreground">KRSBI</strong>, where
									precision, strategy, and teamwork are key to success.
								</span>
							</motion.li>
							...
							>
								...
								<span className="text-md lg:text-lg text-text">
									Beyond competition, we value{" "}
									<strong className="text-foreground">
										learning through hands-on experience
									</strong>
									, fostering innovation, teamwork, and a lasting passion for
									robotics.
								</span>
							</motion.li>
						</ul>
